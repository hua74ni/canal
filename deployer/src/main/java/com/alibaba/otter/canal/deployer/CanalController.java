...
public class CanalController {
    ...
    /**
     * managerClients   PlainCanalConfigClient
    ...
    public void start() throws Throwable {
        ...
        // 创建整个canal的工作节点   /otter/canal/cluster/ registerIp:port
        ...
        /**
         * 如果用户选择了serverMode为mq，那么就不会启动canalServerWithNetty，采用mqStarter来作为server，直接跟mq集群交互。
         * canalServerWithNetty只有在serverMode为tcp时才启动，用来跟canal-client做交互。
         *
         * 启动网络接口
         */
        if (canalServer != null) {
